...
export const teamInfo = [
  ...
  },
  {
    ...
    position_ka: `დირექტორის მოადგილე`,
    position_eng: `Deputy Director`,
  ...
  },
  {
    ...
    position_ka: `კონსულტანტი`,
    position_eng: `Consultant`,
  ...
  },
  {
    ...
    biography_ka: `იოსებ გურული- გამოცდილი Full Stack Developer, რომლის პორტფოლიო გამოირჩევა საერთაშორისო პროექტების წარმატებით შესრულებით. იგი პროფესიონალურ დონეზე ფლობს JavaScript-ის ფრეიმვორკებს, როგორებიცაა  Next.js, Node.js, React.js, and Nest.js.  მისი ნამუშევრები გამოირჩევა მაღალი ხარისხისა და  რთული საკითხების შესრულებით.  ამ სფეროში სამ წლიანი გამოცდილებით იგი მუდმივად ხვეწავს და ავითარებს მის უნარებს, ყოველთვის თვალს ადევნებს და მიჰყვება თანამედროვე ტენდენციებს. იგი ყოველთვის ცდილობს, რომ მისი ყოველი შესრულებული პროექტი იყოს სრულყოფილი, ზუსტი და ინოვაციური.`,
  },
];
