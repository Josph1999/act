import AppealIcon from "../icons/AppealIcon";
...
export const mainAboutData = [
  ...
  },
  {
    ...
    title_eng: "Founder",
    description_ka:
      "დავით ბეჟუაშვილმა 1993 წელს დაამთავრა ივანე ჯავახიშვილის სახელობის თბილისის სახელმწიფო უნივერსიტეტის ეკონომიკის ფაკულტეტი (სპეციალობა: მაკროეკონომიკა), ბაკალავრი; ეკონომიკის მაგისტრი",
    description_eng: `In 1993, Davit Bezhuashvili graduated from Ivane Javakhishvili Tbilisi State University, Faculty of Economics (macroeconomics), bachelor's degree; Master of Economics`,
    icon: <FounderIcon />,
  ...
  },
  {
    ...
    description_eng: `For the last few years, Georgia has been undergoing significant changes, which, first of all, involves the utilization of its economic, political and cultural potential and thus the modernization of the country. In addition, modernization of the country`,
    icon: <AppealIcon />,
    path: "/about?data=Founder",
  },
  {
