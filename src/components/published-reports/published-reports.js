...
import styles from "./published-reports.module.css";
            ...
            >
              ...
              <div>
                <Button
                  ...
                  variant="contained"
                  onClick={() => router.push("/dashboard/add-calculation")}
                >
                  {renderLanguage("წლიური ანგარიშის დამატება", "Add Partner")}
                </Button>
              </div>
            </Stack>
            <Box className={styles.cardsContainer}>
              {loading
                ...
                : paginatedreports?.map((item) => (
                    <AdminReportsCard reports={item} key={item.id} onDelete={deleteNews}/>
                  ))}
            </Box>
            <Box
              sx={{
...
export default MyPublishedreports;
