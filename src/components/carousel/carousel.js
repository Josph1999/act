...
const Carousel = ({ raffles, setRaffles }) => {
    ...
    >
      ...
      >
        {raffles?.length > 0 ? (
          raffles?.map((raffle) => (
            <SwiperSlide>
              <RaffleCard raffle={raffle} setOpen={setOpen} setRaffle={setRaffle} raffles={raffles} setRaffles={setRaffles}/>
            </SwiperSlide>
          ))
        ) : (
          <Box sx={{ width: "100%", height: "450px", textAlign: "center", display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
